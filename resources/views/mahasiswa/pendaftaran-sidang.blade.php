                    ...
                    @if($pengajuan->status_koordinator === 'verified')
                        @if($pengajuan->status_jadwal === 'submitted')
                            ...
                            <a href="{{ route('mahasiswa.jadwal-sidang') }}"
                                ...
                                Menuju Jadwal Sidang
                            </a>
                        @else
                            <p class="text-[14px] text-[#1A1A1A] font-medium">
                                Informasi jadwal sidang akan diberikan jika telah dibuat oleh koordinator.
                            </p>
                        @endif
                    @else
                        <p class="text-[14px] text-[#1A1A1A] font-medium">Informasi selanjutnya akan diumumkan oleh koordinator KP melalui Email atau Notifikasi</p>
                    @endif
                </div>
            ...
            @else
                ...
                <form id="formPendaftaranSidang" action="{{ route('mahasiswa.pendaftaran-sidang.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="flex justify-center mt-6">
                        ...
                        <div class="w-full sm:w-auto bg-gray-200 text-gray-500 font-bold h-[45px] px-10 rounded-full text-[13px] flex items-center justify-center shadow-sm">
