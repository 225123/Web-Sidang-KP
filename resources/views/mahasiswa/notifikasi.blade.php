<x-dashboard-layout header="Notifikasi" userName="{{ auth()->user()->name }}" roleName="MAHASISWA">
    <x-slot:sidebar>
                ...
                <table class="w-full border-collapse text-[11px]">
                    <thead>
                        <tr class="bg-[#EBEBEB] text-black text-center">
                            ...
                            <th class="py-3 px-4 font-bold text-center border-b border-r border-gray-300 w-[200px]">Dari</th>
                        ...
                        <template x-for="(notif, index) in paginatedList" :key="notif.id">
                            <tr class="hover:bg-gray-50 transition-colors" :class="!notif.is_read ? 'bg-gray-100' : ''">
                                ...
                                <td class="py-3 px-4 border-r border-gray-200">
                                    ...
                                    <span class="text-blue-600 block text-[10px] uppercase font-bold mt-0.5">Koordinator KP</span>
                                </td>
