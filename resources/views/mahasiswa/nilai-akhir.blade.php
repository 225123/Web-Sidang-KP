    ...
    <div class="mt-6 max-w-6xl mx-auto space-y-6 pb-12">
        ...
        <div class="bg-[#EBEBEB] rounded-[10px] p-8 shadow-sm border border-[#CAC0C0]">
            ...
            <div class="mt-12 flex justify-end gap-4">
                @if($sidang)
                    <a href="#" class="bg-[#EA3323] hover:bg-red-700 text-white font-bold text-[13px] px-8 py-3 rounded-[5px] flex items-center gap-2 shadow-sm transition-all uppercase tracking-wide">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
                        Download Nilai
                    </a>
                    <a href="#" class="bg-[#4285F4] hover:bg-blue-600 text-white font-bold text-[13px] px-8 py-3 rounded-[5px] flex items-center gap-2 shadow-sm transition-all uppercase tracking-wide">
                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 10v6m0 0l-3-3m3 3l3-3m2 8H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z"></path></svg>
