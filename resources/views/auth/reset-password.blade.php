<x-guest-layout>
    <div class="mb-8">
        ...
        <p class="text-sm text-gray-600 mt-2">Masukkan password baru Anda di bawah ini. Gunakan kombinasi yang kuat dan mudah diingat.</p>
    </div>
    ...
    <form method="POST" action="{{ route('password.store') }}" class="space-y-5" x-data="{
        ...
        <!-- Email Address (read-only, pre-filled) -->
        <div>
        ...
        <div>
            ...
            <div class="mt-2 relative rounded-md shadow-sm">
                ...
                <input id="password" :type="showPassword ? 'text' : 'password'" name="password" x-model="password" @input="showMismatchError = false"
        ...
        <div>
            ...
            <div class="mt-2 relative rounded-md shadow-sm">
                ...
                <input id="password_confirmation" :type="showConfirm ? 'text' : 'password'" name="password_confirmation" x-model="password_confirmation" @input="showMismatchError = false"
                    required autocomplete="new-password"
                    class="block w-full pl-10 pr-10 pt-3 pb-3 sm:text-sm border-gray-300 rounded-lg focus:ring-blue-500 focus:border-blue-500 transition-colors"
        ...
        <div class="pt-2">
            <button type="submit"
                class="w-full flex justify-center py-3 px-4 border border-transparent rounded-lg shadow-sm text-sm font-bold text-white bg-blue-600 hover:bg-blue-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition-colors transform hover:-translate-y-0.5">
