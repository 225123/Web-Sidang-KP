<x-dashboard-layout header="DASHBOARD" userName="{{ auth()->user()->name ?? 'NAMA - 123456789' }}"
    ...
    <div class="flex flex-col gap-6 mt-4 w-full">
        <div class="flex flex-wrap gap-4 items-center">
            ...
            <div class="flex gap-4 ml-6">
                <div
                    class="w-[131px] h-[49px] bg-[#3B82F6] rounded-[3.5px] flex flex-col justify-center items-center shadow-sm relative top-[-10px]">
                ...
                <div
                    class="w-[131px] h-[49px] bg-[#E57835] rounded-[3.5px] flex flex-col justify-center items-center shadow-sm relative top-[-10px]">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8">
            <div
                class="lg:col-span-2 bg-[#FEFEFF] rounded-[10px] border border-[#D9D9D9] p-6 h-[302px] relative shadow-sm overflow-hidden flex flex-col">
                ...
                <div
                    class="absolute left-[8%] bottom-[35%] bg-white border border-[#B5A6A6] rounded px-3 py-2 text-[9px] font-medium leading-tight shadow-sm z-10">
            ...
            <div
                class="bg-[#9F9F9F] rounded-[10px] border border-[#D9D9D9] p-6 h-[135px] shadow-sm flex flex-col justify-center">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 min-h-[302px]">
            <div
                class="lg:col-span-2 bg-[#FEFEFF] rounded-[10px] border border-[#D9D9D9] p-8 shadow-sm flex flex-col justify-center">
                ...
                <div class="flex items-center gap-12 w-full h-[180px]">
                    <div class="relative flex-shrink-0"
                        style="width: 170px; height: 170px; border-radius: 50%; background: conic-gradient(#E7DDDD 0% 60%, #3B82F6 60% 100%); transform: rotate(180deg);">
                        <div class="absolute inset-0 m-auto bg-white rounded-full" style="width: 110px; height: 110px;">
                        </div>
                    </div>
            ...
            <div
                class="bg-[#FEFEFF] rounded-[10px] border border-[#D9D9D9] p-6 shadow-sm flex flex-col h-full max-h-[302px]">
                    ...
                    <div class="flex flex-col divide-y divide-[#D9D9D9]">
                        @for($i = 1; $i <= 6; $i++)
                            <div class="py-3">
                                ...
                                <p class="text-[11px] text-[#666666] mt-1 line-clamp-1">Data notifikasi dashboard
                                    koordinator...</p>
                            </div>
                        @endfor
                    </div>
