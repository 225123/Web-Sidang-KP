                ...
                <table class="w-full border-collapse text-[12px] min-w-[1200px]">
                    ...
                    <tbody class="divide-y divide-gray-200 bg-white">
                                ...
                                <td class="py-3 px-4 text-center border-r border-gray-200">
                                    <div class="flex flex-col gap-2 items-center">
                                        <template x-if="sidang.file_revisi">
                                            <a :href="'/storage/' + sidang.file_revisi" target="_blank" class="text-blue-600 hover:underline font-bold flex items-center gap-1 text-[12px]">
                        ...
                        <template x-if="filteredSidangs.length === 0">
                            <tr>
                                <td colspan="7" class="py-12 text-center text-gray-500 italic text-[12px]">Tidak ada data mahasiswa revisi yang sesuai pencarian/filter.</td>
                            </tr>
                        </template>
                    </tbody>
                </table>
