<x-dashboard-layout hidePeriodSelector="true" userName="{{ auth()->user()->name }}" roleName="KOORDINATOR KP">
    <x-slot:sidebar>
    ...
    <x-slot:header>
        <div class="flex items-center gap-4">
            <a href="{{ route('koordinator.bimbingan-saya') }}" class="p-2 hover:bg-gray-100 rounded-full transition-all group shadow-sm border border-gray-200 bg-white">
        ...
        <div class="flex flex-col xl:flex-row gap-6 mb-8 items-start xl:items-stretch">
            <div class="flex-1 bg-[#EAEFFF] border border-[#BACDFB] rounded-[10px] p-5 flex items-center gap-4 shadow-sm">
                ...
                <p class="text-[14px] text-black font-medium leading-relaxed">
                    Tinjau riwayat bimbingan mahasiswa di bawah ini. Sebagai Koordinator, Anda dapat memberikan persetujuan atau penolakan pada tiap log bimbingan.
                </p>
            </div>
