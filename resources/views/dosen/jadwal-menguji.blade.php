<x-dashboard-layout header="Jadwal Sidang & Menguji" userName="{{ auth()->user()->name }}" roleName="DOSEN">
    <x-slot:sidebar>
        @include('dosen.components.sidebar', ['active' => 'jadwal-menguji'])
    </x-slot>

    <x-slot:headerActions>
        <div x-data="{ open: false, selected: 'Genap 2025/2026' }" class="relative w-[212px]">
            <button @click="open = !open" @click.outside="open = false" type="button"
                class="w-full flex items-center justify-between border border-[#CAC0C0] bg-[#FBFBFB] rounded-[5px] shadow-sm text-[13px] font-medium py-1.5 px-3 focus:outline-none focus:border-[#CDA057] focus:ring-1 focus:ring-[#CDA057] cursor-pointer text-black h-[32px]">
    ...
    <div class="w-full flex-1 pb-10 mt-6" x-data="calendarManager()" x-init="init()">
        <style>
        ...
        <div class="flex flex-col gap-8">
            <div class="flex flex-col xl:flex-row gap-6 items-start xl:items-stretch">
                <div class="flex-1 bg-[#EAEFFF] border border-[#BACDFB] rounded-[10px] p-4 flex items-center gap-4 shadow-sm w-full">
                    ...
                    <p class="text-[14px] text-black font-normal leading-relaxed">
                        Jadwal Menguji Sidang KP. Silakan klik tanggal pada kalender untuk melihat jadwal Anda secara spesifik.
                    </p>
                </div>
            </div>
            <!-- Top Side: Calendar -->
            <div class="bg-white rounded-[5px] border border-[#CAC0C0] overflow-hidden flex flex-col shadow-sm">
                ...
                <div class="px-4 py-3 border-b flex flex-wrap items-center gap-6 bg-white shrink-0">
                    ...
                    <div class="flex items-center gap-2">
                        ...
                        <span class="text-[11px] font-bold text-black uppercase">Tanggal Menguji</span>
                    </div>
                    <div class="flex items-center gap-2">
            ...
            <div class="flex flex-col md:flex-row items-center gap-12">
                ...
                <div class="w-full md:w-auto flex flex-col items-center">
                    <div class="relative w-[220px] h-[220px]">
                        ...
                        <div class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none translate-y-2">
                            ...
                            <span class="text-[10px] font-black text-gray-400 uppercase tracking-[0.2em] mt-1">Selesai Diuji</span>
                        </div>
                    </div>
                </div>
                ...
                <div class="flex-1 flex flex-col gap-6">
                    <div class="pb-4 border-b border-gray-100">
                        <h3 class="text-[18px] font-black text-black uppercase leading-tight">Progres Menguji Sidang</h3>
                        <p class="text-[12px] font-medium text-gray-500 mt-1 uppercase tracking-wider">Statistik Akumulasi Jadwal Menguji Anda</p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
                        ...
                        <div class="flex flex-col p-4 bg-green-50 rounded-lg border border-green-100 transition-all hover:shadow-md">
                            <span class="text-[10px] font-black text-green-600/50 uppercase tracking-widest mb-1">Sudah Diuji</span>
                            <div class="flex items-end gap-2">
                        ...
                        <div class="flex flex-col p-4 bg-blue-50 rounded-lg border border-blue-100 transition-all hover:shadow-md">
                            <span class="text-[10px] font-black text-blue-600/50 uppercase tracking-widest mb-1">Antrian Menguji</span>
                            <div class="flex items-end gap-2">
    ...
    <script>
        function calendarManager() {
            return {
                ...
                init() {
                    // Extract unique rooms for filters
                ...
                resetFilters() {
                    this.filters = { waktu: '', ruangan: '', status: '' };
                ...
                get filteredSessions() {
                    return this.allSessions.filter(s => {
                        ...
                        return dateMatch && timeMatch && roomMatch && statusMatch;
                    });
                }
            };
        }
