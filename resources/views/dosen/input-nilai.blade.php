<x-dashboard-layout header="Input Nilai" userName="{{ auth()->user()->name }}" roleName="DOSEN">
    <x-slot:sidebar>
        ...
        <div class="mt-8 px-2 w-full max-w-[1200px] mx-auto" x-data="inputNilaiPage()">
            ...
            <!-- Global Info -->
            <div
                class="bg-[#E6F0FA] border border-[#D0E3F5] rounded-[10px] p-4 lg:p-5 mb-6 flex items-start gap-4 shadow-sm">
                <div
                ...
                <p class="text-[14px] text-[#1A1A1A] font-medium leading-relaxed m-0 mt-0.5">
                    Lakukan penginputan nilai berdasarkan peran anda terhadap KP Mahasiswa. Mulailah penilaian dengan
                    klik tombol Input nilai untuk setiap mahasiswa pada tabel
                </p>
            ...
            <div class="flex items-end h-[36px]">
                <button @click="activeTab = 'penguji'"
                    ...
                    Penguji Sidang
                    <span class="bg-[#4285F4]/10 text-[#4285F4] py-0.5 px-2 rounded-full text-[10px]"
                        x-text="pengujiMenunggu"></span>
                </button>
                <button @click="activeTab = 'pembimbing'"
                    ...
                    Pembimbing KP
                    <span class="bg-[#4285F4]/10 text-[#4285F4] py-0.5 px-2 rounded-full text-[10px]"
                        x-text="pembimbingMenunggu"></span>
                </button>
                <button @click="activeTab = 'supervisor'"
                    ...
                    Supervisor Lapangan
                    <span class="bg-[#4285F4]/10 text-[#4285F4] py-0.5 px-2 rounded-full text-[10px]"
                        x-text="supervisorMenunggu"></span>
                </button>
            </div>

            <div
                class="bg-white rounded-b-[15px] rounded-tr-[15px] border border-gray-200 shadow-sm overflow-hidden relative top-[-1px] mb-8">
                <!-- SECTION 1: TABEL INPUT NILAI PENGUJI -->
                <div x-show="activeTab === 'penguji'" x-transition:enter="transition ease-out duration-200"
                    x-transition:enter-start="opacity-0 translate-y-2"
                    x-transition:enter-end="opacity-100 translate-y-0" class="p-6" x-cloak>
                    <div class="mb-6 flex flex-col sm:flex-row justify-between items-start gap-4">
                        <div>
                            <h3 class="text-[18px] font-bold text-black tracking-tight uppercase">TABEL INPUT NILAI
                                PENGUJI</h3>
                            <p class="text-[12px] text-black/60 font-medium mt-1">Manajemen penilaian mahasiswa
                                bimbingan dan penguji sidang KP.</p>
                        </div>
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-center gap-6 mb-6">
                        <div class="flex flex-wrap items-center gap-4 w-full sm:w-auto">
                            ...
                            <div class="relative flex-1 sm:w-[300px]">
                                ...
                                <input type="text" x-model="searchPenguji"
                            ...
                            <div x-data="{ openFilter: false }" class="relative w-full sm:w-[150px] z-[60]">
                                <button type="button" @click="openFilter = !openFilter"
                                    ...
                                    <span
                                        x-text="filterPelaksanaanPenguji === 'all' ? 'Pelaksanaan' : filterPelaksanaanPenguji"></span>
                                ...
                                <div x-show="openFilter" x-transition x-cloak
                                    ...
                                    <label
                                        class="block px-3 py-2 text-[12px] hover:bg-gray-100 cursor-pointer text-black"><input
                                            type="radio" value="all" x-model="filterPelaksanaanPenguji" class="hidden"
                                            @change="openFilter = false">Semua</label>
                                    <label
                                        class="block px-3 py-2 text-[12px] hover:bg-gray-100 cursor-pointer text-black"><input
                                            type="radio" value="Selesai" x-model="filterPelaksanaanPenguji"
                                            class="hidden" @change="openFilter = false">Selesai</label>
                                    <label
                                        class="block px-3 py-2 text-[12px] hover:bg-gray-100 cursor-pointer text-black"><input
                                            type="radio" value="Berjalan" x-model="filterPelaksanaanPenguji"
                                            class="hidden" @change="openFilter = false">Berjalan</label>
                                    <label
                                        class="block px-3 py-2 text-[12px] hover:bg-gray-100 cursor-pointer text-black"><input
                                            type="radio" value="Menunggu" x-model="filterPelaksanaanPenguji"
                                            class="hidden" @change="openFilter = false">Menunggu</label>
                                    <label
                                        class="block px-3 py-2 text-[12px] hover:bg-gray-100 cursor-pointer text-black"><input
                                            type="radio" value="Dibatalkan" x-model="filterPelaksanaanPenguji"
                                            class="hidden" @change="openFilter = false">Dibatalkan</label>
                                </div>
                            </div>
                            ...
                            <div x-data="{ openFilter: false }" class="relative w-full sm:w-[150px] z-[50]">
                                <button type="button" @click="openFilter = !openFilter"
                                    ...
                                    class="w-full text-[12px] border border-gray-300 rounded-[5px] py-2 px-3 bg-white text-black font-medium focus:ring-[#4285F4] flex justify-between items-center text-left shadow-sm">
                                    <span
                                        x-text="filterPenilaianPenguji === 'all' ? 'Penilaian' : (filterPenilaianPenguji === 'sudah' ? 'Sudah Input' : 'Belum Input')"></span>
                                    <svg :class="openFilter ? 'rotate-0' : 'rotate-90'"
                                        class="w-3.5 h-3.5 transition-all duration-200 text-gray-500 flex-shrink-0"
                                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div x-show="openFilter" x-transition x-cloak
                                    ...
                                    <label
                                        class="block px-3 py-2 text-[12px] hover:bg-gray-100 cursor-pointer text-black"><input
                                            type="radio" value="all" x-model="filterPenilaianPenguji" class="hidden"
                                            @change="openFilter = false">Semua</label>
                                    <label
                                        class="block px-3 py-2 text-[12px] hover:bg-gray-100 cursor-pointer text-black"><input
                                            type="radio" value="sudah" x-model="filterPenilaianPenguji" class="hidden"
                                            @change="openFilter = false">Sudah Input</label>
                                    <label
                                        class="block px-3 py-2 text-[12px] hover:bg-gray-100 cursor-pointer text-black"><input
                                            type="radio" value="belum" x-model="filterPenilaianPenguji" class="hidden"
                                            @change="openFilter = false">Belum Input</label>
                                </div>
                            </div>
                            ...
                            <div x-data="{ openFilter: false }" class="relative w-full sm:w-[150px] z-[40]">
                                <button type="button" @click="openFilter = !openFilter"
                                    ...
                                    class="w-full text-[12px] border border-gray-300 rounded-[5px] py-2 px-3 bg-white text-black font-medium focus:ring-[#4285F4] flex justify-between items-center text-left shadow-sm">
                                    <span
                                        x-text="filterPeranPenguji === 'all' ? 'Peran' : (filterPeranPenguji === 'PENGUJI 1' ? 'Penguji 1' : 'Penguji 2')"></span>
                                    <svg :class="openFilter ? 'rotate-0' : 'rotate-90'"
                                        class="w-3.5 h-3.5 transition-all duration-200 text-gray-500 flex-shrink-0"
                                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div x-show="openFilter" x-transition x-cloak
                                    ...
                                    <label
                                        class="block px-3 py-2 text-[12px] hover:bg-gray-100 cursor-pointer text-black"><input
                                            type="radio" value="all" x-model="filterPeranPenguji" class="hidden"
                                            @change="openFilter = false">Semua Peran</label>
                                    <label
                                        class="block px-3 py-2 text-[12px] hover:bg-gray-100 cursor-pointer text-black"><input
                                            type="radio" value="PENGUJI 1" x-model="filterPeranPenguji" class="hidden"
                                            @change="openFilter = false">Penguji 1</label>
                                    <label
                                        class="block px-3 py-2 text-[12px] hover:bg-gray-100 cursor-pointer text-black"><input
                                            type="radio" value="PENGUJI 2" x-model="filterPeranPenguji" class="hidden"
                                            @change="openFilter = false">Penguji 2</label>
                                </div>
                            </div>

                            <div class="flex gap-2 w-full sm:w-auto">
                                <button type="button" @click="clearPenguji()"
                    ...
                    <div class="border border-gray-200 rounded-[10px] overflow-x-auto">
                        <table class="w-full border-collapse text-[12px] min-w-[1100px]">
                            <thead class="bg-[#EBEBEB] text-black">
                                <tr>
                                    <th
                                        class="py-3 px-4 font-bold text-center w-[60px] border-b border-r border-gray-300">
                                        No</th>
                                    <th
                                        class="py-3 px-4 font-bold text-left border-b border-r border-gray-300 w-[180px]">
                                        Jadwal</th>
                                    <th
                                        class="py-3 px-4 font-bold text-left border-b border-r border-gray-300 w-[150px]">
                                        Peran Sidang</th>
                                    <th
                                        class="py-3 px-4 font-bold text-left border-b border-r border-gray-300 w-[180px]">
                                        Mahasiswa</th>
                                    <th
                                        class="py-3 px-4 font-bold text-left border-b border-r border-gray-300 min-w-[300px]">
                                        Judul KP</th>
                                    <th
                                        class="py-3 px-4 font-bold text-center border-b border-r border-gray-300 w-[120px]">
                                        Status Kelulusan</th>
                                    <th
                                        class="py-3 px-4 font-bold text-center border-b border-r border-gray-300 w-[140px]">
                                        Pelaksanaan</th>
                                    <th class="py-3 px-4 font-bold text-center border-b border-gray-300 w-[150px]">
                                        Penilaian</th>
                                </tr>
                            </thead>
                                ...
                                <template x-for="(sidang, index) in paginatedPenguji" :key="'p-' + sidang.id">
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        <td class="py-3 px-4 text-center text-black/60 border-r border-gray-200"
                                            x-text="((currentPagePenguji - 1) * itemsPerPagePenguji) + index + 1"></td>
                                        ...
                                        <td class="border-r border-[#CAC0C0] px-4 py-4 text-center">
                                            <span class="font-bold text-gray-700"
                                                x-text="sidang.status_kelulusan || '-'"></span>
                                        </td>
                                            ...
                                            <div class="flex flex-col items-center gap-2">
                                                ...
                                                <template x-if="!sidang.is_penguji_1">
                                                    <div class="flex flex-col items-center gap-1">
                                                        ...
                                                        <div
                                                            class="text-[9px] text-gray-400 italic font-medium text-center">
                    ...
                    <div class="px-6 py-4 bg-white flex items-center justify-between border-t border-gray-200"
                        x-show="totalPagesPenguji > 1">
                        <span class="text-[12px] font-medium text-black/50"
                            x-text="(filteredPenguji.length === 0 ? 0 : ((currentPagePenguji - 1) * itemsPerPagePenguji + 1)) + ' - ' + Math.min(currentPagePenguji * itemsPerPagePenguji, filteredPenguji.length) + ' dari ' + filteredPenguji.length + ' baris'"></span>
                        <div class="flex items-center gap-2">
                            <button @click="if(currentPagePenguji > 1) currentPagePenguji--"
                                :disabled="currentPagePenguji === 1"
                            ...
                            <button @click="if(currentPagePenguji < totalPagesPenguji) currentPagePenguji++"
                                :disabled="currentPagePenguji === totalPagesPenguji"
                ...
                <div x-show="activeTab === 'pembimbing'" x-transition:enter="transition ease-out duration-200"
                    x-transition:enter-start="opacity-0 translate-y-2"
                    x-transition:enter-end="opacity-100 translate-y-0" class="p-6" x-cloak>
                    <div class="mb-6 flex flex-col sm:flex-row justify-between items-start gap-4">
                        <div>
                            <h3 class="text-[18px] font-bold text-black tracking-tight uppercase">TABEL INPUT NILAI
                                PEMBIMBING</h3>
                            <p class="text-[12px] text-black/60 font-medium mt-1">Manajemen penilaian mahasiswa khusus
                                untuk peran Anda sebagai Dosen Pembimbing.</p>
                        </div>
                        <div class="flex gap-2 shrink-0">
                            <div
                                class="bg-[#4285F4] text-white rounded-[5px] px-3 py-1.5 flex items-center gap-2 shadow-sm border border-blue-600/20">
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-center gap-6 mb-6">
                        <div class="flex flex-wrap items-center gap-4 w-full sm:w-auto">
                            ...
                            <div class="relative flex-1 sm:w-[300px]">
                                ...
                                <input type="text" x-model="searchPembimbing"
                                    class="block w-full pl-9 pr-4 py-2 border border-gray-300 rounded-[5px] text-[12px] text-black focus:ring-[#4285F4]"
                                    placeholder="Cari Nama/NIM, atau Judul KP...">
                            </div>
                            ...
                            <div x-data="{ openFilter: false }" class="relative w-full sm:w-[150px] z-[50]">
                                <button type="button" @click="openFilter = !openFilter"
                                    ...
                                    class="w-full text-[12px] border border-gray-300 rounded-[5px] py-2 px-3 bg-white text-black font-medium focus:ring-[#4285F4] flex justify-between items-center text-left shadow-sm">
                                    <span
                                        x-text="filterPenilaianPembimbing === 'all' ? 'Penilaian' : (filterPenilaianPembimbing === 'sudah' ? 'Sudah Input' : 'Belum Input')"></span>
                                    <svg :class="openFilter ? 'rotate-0' : 'rotate-90'"
                                        class="w-3.5 h-3.5 transition-all duration-200 text-gray-500 flex-shrink-0"
                                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div x-show="openFilter" x-transition x-cloak
                                    ...
                                    <label
                                        class="block px-3 py-2 text-[12px] hover:bg-gray-100 cursor-pointer text-black"><input
                                            type="radio" value="all" x-model="filterPenilaianPembimbing" class="hidden"
                                            @change="openFilter = false">Semua</label>
                                    <label
                                        class="block px-3 py-2 text-[12px] hover:bg-gray-100 cursor-pointer text-black"><input
                                            type="radio" value="sudah" x-model="filterPenilaianPembimbing"
                                            class="hidden" @change="openFilter = false">Sudah Input</label>
                                    <label
                                        class="block px-3 py-2 text-[12px] hover:bg-gray-100 cursor-pointer text-black"><input
                                            type="radio" value="belum" x-model="filterPenilaianPembimbing"
                                            class="hidden" @change="openFilter = false">Belum Input</label>
                                </div>
                            </div>

                            <div class="flex gap-2 w-full sm:w-auto">
                                <button type="button" @click="clearPembimbing()"
                                    class="flex-1 sm:flex-none border border-[#EA4335] bg-[#EA4335] text-white hover:bg-red-600 transition-colors px-4 py-1.5 rounded-[5px] text-[12px] font-bold shadow-sm flex items-center justify-center">
                                    Clear Filter
                                </button>
                            </div>
                            ...
                            <thead class="bg-[#EBEBEB] text-black">
                                <tr>
                                    <th
                                        ...
                                        No</th>
                                    <th
                                        class="py-3 px-4 font-bold text-left border-b border-r border-gray-300 w-[250px]">
                                        Mahasiswa</th>
                                    <th class="py-3 px-4 font-bold text-left border-b border-r border-gray-300">Judul KP
                                    </th>
                                    <th
                                        class="py-3 px-4 font-bold text-center border-b border-r border-gray-300 w-[150px]">
                                        Status</th>
                                    <th class="py-3 px-4 font-bold text-center border-b border-gray-300 w-[200px]">
                                        Penilaian</th>
                                </tr>
                            </thead>
                            <tbody class="divide-y divide-gray-200 bg-white">
                                <template x-for="(sidang, index) in paginatedPembimbing" :key="'pb-' + sidang.id">
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        <td class="py-3 px-4 text-center text-black/60 border-r border-gray-200"
                                            x-text="((currentPagePembimbing - 1) * itemsPerPagePembimbing) + index + 1">
                                        </td>
                                        <td class="py-3 px-4 text-left border-r border-gray-200">
                                            <div class="font-bold text-black uppercase"
                                                x-text="sidang.mahasiswa.user.name"></div>
                                        ...
                                        <td class="border-r border-[#CAC0C0] px-4 py-4 text-center">
                                            <template x-if="sidang.nilai_pembimbing !== null">
                                                <span
                                                    class="inline-flex items-center gap-1.5 bg-green-100 text-green-700 px-3 py-1 rounded-full font-bold text-[10px] uppercase shadow-sm">
                                                    Dinilai
                                                </span>
                                            </template>
                                            <template x-if="sidang.nilai_pembimbing === null">
                                                <span
                                                    class="inline-flex items-center gap-1.5 bg-yellow-100 text-yellow-700 px-3 py-1 rounded-full font-bold text-[10px] uppercase shadow-sm">
                                                    Menunggu
                                                </span>
                                            </template>
                                        </td>
                    ...
                    <!-- Pagination Matching Standard Style -->
                    <div class="px-6 py-4 bg-white flex items-center justify-between border-t border-gray-200"
                        x-show="totalPagesPembimbing > 1">
                        <span class="text-[12px] font-medium text-black/50"
                            x-text="(filteredPembimbing.length === 0 ? 0 : ((currentPagePembimbing - 1) * itemsPerPagePembimbing + 1)) + ' - ' + Math.min(currentPagePembimbing * itemsPerPagePembimbing, filteredPembimbing.length) + ' dari ' + filteredPembimbing.length + ' baris'"></span>
                        <div class="flex items-center gap-2">
                            <button @click="if(currentPagePembimbing > 1) currentPagePembimbing--"
                                :disabled="currentPagePembimbing === 1"
                                class="px-3 py-1 border border-gray-300 rounded text-[12px] hover:bg-gray-50 disabled:opacity-30 disabled:cursor-not-allowed transition-colors">Previous</button>
                            <div class="flex items-center gap-1">
                            ...
                            <button @click="if(currentPagePembimbing < totalPagesPembimbing) currentPagePembimbing++"
                                :disabled="currentPagePembimbing === totalPagesPembimbing"
                                class="px-3 py-1 border border-gray-300 rounded text-[12px] hover:bg-gray-50 disabled:opacity-30 disabled:cursor-not-allowed transition-colors">Next</button>
                        </div>
                    </div>
                </div>
                ...
                <div x-show="activeTab === 'supervisor'" x-transition:enter="transition ease-out duration-200"
                    x-transition:enter-start="opacity-0 translate-y-2"
                    x-transition:enter-end="opacity-100 translate-y-0" class="p-6" x-cloak>
                    <div class="mb-6 flex flex-col sm:flex-row justify-between items-start gap-4">
                        <div>
                            <h3 class="text-[18px] font-bold text-black tracking-tight uppercase">TABEL INPUT NILAI
                                SUPERVISOR</h3>
                            <p class="text-[12px] text-black/60 font-medium mt-1">Manajemen penilaian mahasiswa untuk
                                peran Anda sebagai Supervisor (Pembimbing Lapangan).</p>
                        </div>
                        <div class="flex gap-2 shrink-0">
                            <div
                                class="bg-[#4285F4] text-white rounded-[5px] px-3 py-1.5 flex items-center gap-2 shadow-sm border border-blue-600/20">
                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-center gap-6 mb-6">
                        <div class="flex flex-wrap items-center gap-4 w-full sm:w-auto">
                            ...
                            <div class="relative flex-1 sm:w-[300px]">
                                ...
                                <input type="text" x-model="searchSupervisor"
                                    class="block w-full pl-9 pr-4 py-2 border border-gray-300 rounded-[5px] text-[12px] text-black focus:ring-[#4285F4]"
                                    placeholder="Cari Nama/NIM, atau Judul KP...">
                            </div>
                            ...
                            <div x-data="{ openFilter: false }" class="relative w-full sm:w-[150px] z-[50]">
                                <button type="button" @click="openFilter = !openFilter"
                                    ...
                                    class="w-full text-[12px] border border-gray-300 rounded-[5px] py-2 px-3 bg-white text-black font-medium focus:ring-[#4285F4] flex justify-between items-center text-left shadow-sm">
                                    <span
                                        x-text="filterPenilaianSupervisor === 'all' ? 'Penilaian' : (filterPenilaianSupervisor === 'sudah' ? 'Sudah Input' : 'Belum Input')"></span>
                                    <svg :class="openFilter ? 'rotate-0' : 'rotate-90'"
                                        class="w-3.5 h-3.5 transition-all duration-200 text-gray-500 flex-shrink-0"
                                        fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <div x-show="openFilter" x-transition x-cloak
                                    ...
                                    <label
                                        class="block px-3 py-2 text-[12px] hover:bg-gray-100 cursor-pointer text-black"><input
                                            type="radio" value="all" x-model="filterPenilaianSupervisor" class="hidden"
                                            @change="openFilter = false">Semua</label>
                                    <label
                                        class="block px-3 py-2 text-[12px] hover:bg-gray-100 cursor-pointer text-black"><input
                                            type="radio" value="sudah" x-model="filterPenilaianSupervisor"
                                            class="hidden" @change="openFilter = false">Sudah Input</label>
                                    <label
                                        class="block px-3 py-2 text-[12px] hover:bg-gray-100 cursor-pointer text-black"><input
                                            type="radio" value="belum" x-model="filterPenilaianSupervisor"
                                            class="hidden" @change="openFilter = false">Belum Input</label>
                                </div>
                            </div>

                            <div class="flex gap-2 w-full sm:w-auto">
                                <button type="button" @click="clearSupervisor()"
                                    class="flex-1 sm:flex-none border border-[#EA4335] bg-[#EA4335] text-white hover:bg-red-600 transition-colors px-4 py-1.5 rounded-[5px] text-[12px] font-bold shadow-sm flex items-center justify-center">
                                    Clear Filter
                                </button>
                            </div>
                        ...
                        <table class="w-full border-collapse text-[12px] min-w-[1100px]">
                            ...
                            <tbody class="divide-y divide-gray-200 bg-white">
                                <template x-for="(sidang, index) in paginatedSupervisor" :key="'sv-' + sidang.id">
                                    <tr class="hover:bg-gray-50 transition-colors">
                                        <td class="py-3 px-4 text-center text-black/60 border-r border-gray-200"
                                            x-text="((currentPageSupervisor - 1) * itemsPerPageSupervisor) + index + 1">
                                        </td>
                                        <td class="py-3 px-4 text-left border-r border-gray-200">
                                            <div class="font-bold text-black uppercase"
                                                x-text="sidang.mahasiswa.user.name"></div>
                    ...
                    <!-- Pagination Matching Standard Style -->
                    <div class="px-6 py-4 bg-white flex items-center justify-between border-t border-gray-200"
                        x-show="totalPagesSupervisor > 1">
                        <span class="text-[12px] font-medium text-black/50"
                            x-text="(filteredSupervisor.length === 0 ? 0 : ((currentPageSupervisor - 1) * itemsPerPageSupervisor + 1)) + ' - ' + Math.min(currentPageSupervisor * itemsPerPageSupervisor, filteredSupervisor.length) + ' dari ' + filteredSupervisor.length + ' baris'"></span>
                        <div class="flex items-center gap-2">
                            <button @click="if(currentPageSupervisor > 1) currentPageSupervisor--"
                                :disabled="currentPageSupervisor === 1"
                                class="px-3 py-1 border border-gray-300 rounded text-[12px] hover:bg-gray-50 disabled:opacity-30 disabled:cursor-not-allowed transition-colors">Previous</button>
                            <div class="flex items-center gap-1">
                            ...
                            <button @click="if(currentPageSupervisor < totalPagesSupervisor) currentPageSupervisor++"
                                :disabled="currentPageSupervisor === totalPagesSupervisor"
                                class="px-3 py-1 border border-gray-300 rounded text-[12px] hover:bg-gray-50 disabled:opacity-30 disabled:cursor-not-allowed transition-colors">Next</button>
                        </div>
                    </div>
            ...
            <div x-show="showConfirmModal" style="display: none;"
                ...
                <div @click.away="cancelUpdate()"
                    class="bg-white rounded-[10px] w-full max-w-[450px] p-8 shadow-2xl flex flex-col items-center justify-center text-center transform transition-all">
                    ...
                    <!-- Message -->
                    <h3 class="text-black font-semibold text-[16px] mb-8">Apakah Anda yakin ingin memperbarui status
                        pelaksanaan menjadi <span class="font-bold text-blue-600"
                            x-text="confirmData ? confirmData.newStatus : ''"></span>?</h3>

                    <!-- Buttons -->
                    <div class="flex gap-4 w-full justify-center">
                        <button @click="cancelUpdate()" type="button"
                            class="w-[100px] h-[34px] bg-[#E32727] hover:bg-red-700 text-white rounded-[5px] text-[14px] font-medium transition-colors shadow-sm">
                            Batal
                        </button>
                        <button @click="executeUpdate()" type="button"
                            class="w-[100px] h-[34px] bg-[#456DA7] hover:bg-blue-700 text-white rounded-[5px] text-[14px] font-medium transition-colors shadow-sm">
                            Iya
                        </button>
                    </div>
                </div>
            ...
            <div x-show="showSuccessModal" style="display: none;"
                class="fixed inset-0 z-[110] flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
                <div
                    class="bg-white rounded-[10px] w-full max-w-[400px] p-6 shadow-2xl flex flex-col items-center text-center">
                    ...
                    <button @click="showSuccessModal = false"
                        class="mt-6 w-full h-[36px] bg-green-500 hover:bg-green-600 text-white rounded-[5px] text-[13px] font-bold transition-colors">Tutup</button>
                </div>
            </div>
            ...
            <div x-show="showErrorModal" style="display: none;"
                ...
                <div
                    ...
                    <button @click="showErrorModal = false"
                        class="mt-6 w-full h-[36px] bg-red-500 hover:bg-red-600 text-white rounded-[5px] text-[13px] font-bold transition-colors">Tutup</button>
                </div>
            </div>
        </div>
