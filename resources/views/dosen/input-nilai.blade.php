<x-dashboard-layout header="Input Nilai Sidang" userName="{{ auth()->user()->name }}" roleName="DOSEN">
    ...
    <div x-data="inputNilaiPage()" class="p-6">
        ...
        <div class="mb-6">
            <div class="bg-[#E6F0FA] border border-[#D0E3F5] rounded-[10px] p-4 lg:p-5 flex items-start gap-4 shadow-sm w-full">
                ...
                <p class="text-[14px] text-black font-normal leading-relaxed m-0 mt-0.5">
                    Manajemen penilaian mahasiswa bimbingan dan penguji sidang KP. <br>
                    Data dipisahkan berdasarkan peran Anda. Pelaksanaan sidang hanya dikelola oleh Penguji 1.
                </p>
            </div>
        </div>

        <!-- Filter & Search Bar -->
        <div class="bg-white p-3 rounded-[5px] shadow-sm border border-[#CAC0C0] mb-8 flex flex-wrap gap-3 items-center">
            ...
            <div class="flex gap-2 items-center">
                ...
                <select x-model="sortBy" class="border border-[#CAC0C0] rounded-[5px] px-3 py-2 text-[13px] focus:outline-none focus:border-[#4CC098] bg-white cursor-pointer font-medium">
                                        ...
                                        <div class="flex flex-col items-center gap-2">
                                            ...
                                            <template x-if="sidang.is_penguji_1">
                                                <select @change="updateStatus(sidang.id, $event.target.value)" 
                                                    ...
                                                    <option value="Menunggu" :selected="sidang.pelaksanaan === 'Menunggu'">Atur Menunggu</option>
                                                    <option value="Berjalan" :selected="sidang.pelaksanaan === 'Berjalan'">Atur Berjalan</option>
                                                    <option value="Selesai" :selected="sidang.pelaksanaan === 'Selesai'">Set Selesai</option>
                                                    <option value="Dibatalkan" :selected="sidang.pelaksanaan === 'Dibatalkan'">Set Batal</option>
                                                </select>
                                            </template>
                                            <template x-if="!sidang.is_penguji_1">
                                                <div class="text-[10px] text-gray-400 italic font-medium mt-1 text-center">Otoritas Penguji 1</div>
                                            </template>
                                        </div>
                                    </td>
                                    <td class="px-4 py-4">
