<x-dashboard-layout header="Log Bimbingan" userName="{{ auth()->user()->name }}" roleName="DOSEN">
    <x-slot:sidebar>
        ...
        <div class="mt-6">
            ...
            <div class="flex justify-between items-center mb-2">
                ...
                <a href="{{ route('dosen.daftar-mahasiswa') }}" class="text-black font-bold">></a>
            </div>
                                    ...
                                    <td class="py-4 px-2">
                                        @if($log->status_approval == 'pending')
                                            <div class="flex items-center justify-center gap-2">
                                                <form action="{{ route('dosen.daftar-mahasiswa.updateStatus', $log->id) }}"
