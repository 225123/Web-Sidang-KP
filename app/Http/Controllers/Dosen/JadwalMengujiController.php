...
class JadwalMengujiController extends Controller
{
    ...
    public function inputNilai($id)
    {
        ...
        $role = null;
        if ($sidang->penguji_1_id == $userId) $role = 'penguji1';
        elseif ($sidang->penguji_2_id == $userId) $role = 'penguji2';
        elseif ($sidang->pendaftaranKp->supervisor_internal_id == $userId) $role = 'pembimbing';
    ...
    public function storeNilai(Request $request, $id)
    {
        ...
        if ($role == 'penguji1') $sidang->nilai_penguji_1 = $request->nilai;
        elseif ($role == 'penguji2') $sidang->nilai_penguji_2 = $request->nilai;
        elseif ($role == 'pembimbing') $sidang->nilai_pembimbing = $request->nilai;
