...
# Remove the trailing "<!-- Search & Filters -->\n                    <div class="flex flex-col xl:flex-row gap-4">..." that might be left.
# Wait, actually we can just regex substitute everything until the table div!
content = re.sub(
...
# Now fix the table headers and bodies.
...
content = content.replace('class="border-r border-[#CAC0C0] px-4 py-2', 'class="py-3 px-4 font-bold text-center border-b border-r border-gray-300')
content = content.replace('class="px-4 py-2', 'class="py-3 px-4 font-bold text-center border-b border-gray-300')
